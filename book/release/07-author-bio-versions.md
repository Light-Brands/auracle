...
## Jennifer Brooke Lawless, M.S. · writes and creates as Jae Lawless

Use these versions across platforms. Each volume has its own back-matter bio that evolves with the reader's journey.

**Brand architecture:**
- **Trust layer (books, credentials):** Jennifer Brooke Lawless, M.S.
- **Connection layer (digital, social):** Jae Lawless
- **Transformation layer (platform):** Auracle
...
|--------|-------|-----------|----------|
| **1** | Recognition | *Surviving & naming patterns* | `vol-1-see/back-matter-about-author.md` |
| **2** | Healing | *Crossing from insight to embodiment* | `vol-2-heal/back-matter-about-author.md` |
| **3** | Stand | *Living from embodied authority* | `vol-3-stand/back-matter-about-author.md` |
...
*For: Gumroad, Substack, guest post bylines, About pages*

Jennifer Brooke (Saltzman) Lawless, M.S. is a therapist, writer, and survivor of narcissistic abuse. She holds degrees in Psychology and Mental Health Counseling, with clinical experience spanning psychiatric care, family systems therapy, and couples work.
...
*For: Website About page, long-form press features*

Jennifer Brooke (Saltzman) Lawless, M.S. is a therapist, writer, and the creator of Auracle — a platform for sensitive adults learning to decode patterns, heal their nervous systems, and reclaim their sovereignty.

She holds a Bachelor of Science in Psychology from Boston University and a Master of Science in Mental Health Counseling from Nova Southeastern University. Her clinical work has ranged from locked psychiatric units to family systems therapy and couples counseling. But none of her training prepared her for what she really needed to learn: how to recognize when love is actually control in disguise.
...
- **Professional / clinical contexts:** Lead with Jennifer Brooke Lawless, M.S. and her credentials
- **Digital / social contexts:** Lead with Jae Lawless; reference Jennifer only for the depth bridge
- **About page / depth contexts:** Use Jennifer Brooke (Saltzman) Lawless — the Saltzman honors maternal lineage
- The Costa Rica detail humanizes and differentiates—keep it
- **Always include the bridge:** In any Jennifer-forward bio, add "writes and creates as Jae Lawless" so readers can find her online
- See `docs/personal-brand-strategy.md` for the full name usage matrix
