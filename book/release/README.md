...
|--------|-------|---------------|-------|
| **1** | The Decoder | *What is happening to me?* | Pattern recognition, naming tactics |
...
| **4** | The Presence | *How do I live from presence?* | Aura, erotic coherence, full expression |
...
- [ ] **Read** `01-platform-setup-guide.md` and set up accounts
- [ ] **Convert** `02-decoder-cards-lead-magnet.md` to PDF for Gumroad (free, email capture)
- [ ] **Copy** descriptions from `03-book-descriptions.md` to Amazon/Gumroad
- [ ] **Follow** `04-formatting-guide.md` to prepare manuscripts

### Phase 2: Volume 1 Launch (Week 3-4)

- [ ] Upload Volume 1 to Amazon KDP and Gumroad
- [ ] Publish Decoder Cards as free lead magnet on Gumroad
- [ ] Set up Substack with welcome email
- [ ] Begin content calendar from `05-content-calendar.md`
...
Each book chapter generates 4-6 weeks of content:
...
| Product | Amazon | Gumroad |
|---------|--------|---------|
| Vol 1 Ebook | $4.99-6.99 | $9.99 (with Decoder Cards) |
...
1. Demonstrate expertise (build trust)
