...
When you're ready to move from recognition to healing, **[Volume 2: Heal](../vol-2-heal/README.md)** continues with:
- Secure attachment training
- Reparenting practices
- Dating after trauma
- Building relationships that regulate rather than activate

When you're ready to move from healing to sovereignty, **[Volume 3: Stand](../vol-3-stand/README.md)** continues with:
