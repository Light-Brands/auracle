...
|-----------|----------|----------|
| Volume 2: Heal | Front Matter | ✓ |
| Volume 4: Live | Chapter 18 | QUERY |
...
| Ch 18 | Lines 282-283, 349 reference "Volume 4: Live" - verify exists | RESOLVED | Volume 4 is planned; reference to future volume is intentional and acceptable |
