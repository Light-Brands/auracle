...
The body learns: *Repair is unsafe.*
...
The body updates: *I can remain myself and still be connected.*
...
**Integration Line:** Failed repair teaches the body that speaking up creates new danger.

---

## 4. Dating Phase Red Flag Box: Repair & Consent
...
**Repair works when:** Nothing is required in return.
...
## 7. Gottman's Four Horsemen with Trauma Overlay

### How Trauma Distorts the Four Horsemen
*(Original commentary on Gottman's framework)*

**Big Reframe:** Gottman identified what destroys relationships. Trauma explains why those behaviors appear and why they're so hard to stop.
...
**Trauma-Informed Truth (Important):** Contempt is not just dysregulation. It is unprocessed shame combined with power. This is why contempt rarely self-corrects, repair often fails, and distance is sometimes necessary.
...
|---------|-----------------|
| Neuroscience of Repair | Vol 2, Ch 17 (Dating After Trauma) - sidebar |
| False vs Real Repair | Vol 2, Ch 17 - new subsection |
| "The Almost" vignette | Vol 2, Ch 17 - field note insert |
| Red/Green Flag Box | Vol 2, Ch 17 - practical tool |
| Real-Time Litmus Test | Vol 2, Appendix C or Ch 17 |
| Partner-Facing Guide | Vol 2, Ch 18 (Partner Compatibility) |
| Gottman + Trauma | Vol 2, Ch 8 (Attachment Styles) or new appendix |
