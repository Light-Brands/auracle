...
if ! command -v gh &> /dev/null; then
    ...
    echo "Using the content from: /home/user/auracle/book/vol-1-see/review-03/github-issue-body.txt"
    echo ""
...
gh issue create \
  ...
  --body-file /home/user/auracle/book/vol-1-see/review-03/github-issue-body.txt
