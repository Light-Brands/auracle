...
const TestimonialsSection = () => {
  const testimonials = [
    ...
    },
    {
      name: 'David L.',
      location: 'Toronto',
      text: 'As someone new to energy work, I was amazed by how accessible Jae makes these profound teachings. The Golden Sun visualization has become my daily anchor.',
      rating: 5,
      image: '☀️',
    },
    {
      name: 'Maya S.',
      location: 'Sydney',
      text: 'The community aspect of Auracle is incredible. Learning alongside others on this sacred journey has enriched my practice immeasurably. Jae creates such a safe, nurturing space.',
      rating: 5,
      image: '🌹',
    },
    {
      name: 'James W.',
      location: 'Berlin',
      text: "My aura reading revealed patterns I never recognized before. Jae's compassionate approach and practical guidance have helped me cultivate deeper self-awareness and energetic boundaries.",
      rating: 5,
      image: '🕊️',
    },
  ];
