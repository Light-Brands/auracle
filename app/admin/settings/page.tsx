...
import {
  ...
  SacredTextarea,
  SacredSelect,
} from '../../../components/admin/SacredUI';

export default function SettingsPage() {
  const [activeTab, setActiveTab] = useState<
    'profile' | 'notifications' | 'security' | 'branding' | 'integrations' | 'advanced'
  >('profile');
            ...
            {activeTab === 'profile' && (
              <div className="space-y-6">
                ...
                <SacredTextarea
                  ...
                  onChange={(value) =>
                    setProfileSettings((prev) => ({ ...prev, bio: value }))
                  }
                  rows={4}
                ...
                <div className="space-y-6">
                  <SacredCard>
                    ...
                    <div className="space-y-4">
                      ...
                      <SacredButton variant="primary">Update Password</SacredButton>
                    </div>
            ...
            {activeTab === 'branding' && (
              <div className="space-y-6">
                <div className="mb-6">
                  ...
                  <p className="text-gray-600">
                    Customize your platform&apos;s sacred visual identity
                  </p>
                </div>
            ...
            {activeTab === 'integrations' && (
              <div className="space-y-6">
                <div className="mb-6">
                  ...
                  <p className="text-gray-600">
                    Connect your sacred tools and services
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <SacredCard>
                    ...
                    <p className="text-sm text-gray-500 mt-3">
                      Export includes courses, students, and analytics data in JSON
                      format
                    </p>
                  </SacredCard>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-red-50 rounded-xl">
                        ...
                        <p className="text-sm text-red-700 mb-3">
                          This will reset all your settings to default values. This
