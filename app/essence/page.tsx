  ...
  const essenceAreas = [
    {
      ...
      description:
        'Connect with your spiritual guides who have messages specifically for you. These divine beings offer wisdom, comfort, and guidance from the other side.',
      details: [
    ...
    },
    {
      ...
      description:
        "Discover how your soul's journey through different lifetimes affects your current experiences, relationships, and life patterns.",
      details: [
    ...
    },
    {
      ...
      description:
        'Receive guidance on your most pressing life questions and discover the deeper spiritual meaning behind your current challenges and opportunities.',
      details: [
    ...
    },
    {
      ...
      description:
        'Understand your energetic state and receive healing guidance to restore balance, clear blockages, and strengthen your spiritual connection.',
      details: [
    ...
    },
    {
      ...
      description:
        'Decode the spiritual messages in your dreams, synchronicities, and the signs that appear in your daily life.',
      details: [
    ...
    },
    {
      ...
      description:
        'The comprehensive experience combining spirit connection, past life insights, life guidance, and energy healing in one transformative session.',
      details: [
  ...
  const preparationSteps = [
    {
      ...
      description:
        "Find a quiet, private area where you won't be interrupted. Light a candle or incense if it feels right.",
      icon: '🕯️',
    },
    {
      title: 'Prepare Your Questions',
      description:
        "Write down any specific questions or areas where you're seeking guidance. Trust that what you need to know will come through.",
      icon: '📝',
    },
    {
      title: 'Open Your Heart',
      description:
        'Come with an open mind and heart. The more receptive you are, the clearer the messages and healing can flow.',
      icon: '💖',
    },
    {
      title: 'Trust the Process',
      description:
        "Your guides know exactly what you need to hear. Even if messages seem unexpected, trust that they're divinely timed.",
      icon: '✨',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
              Understanding the deeper spiritual dimensions we explore together. Each
              session is a journey into the sacred, guided by divine love and infinite
              wisdom.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Every session is unique, guided by your soul&apos;s needs and what your
              spirit guides want you to know.
            </p>
          </motion.div>
            ...
            {essenceAreas.map((area, index) => (
              ...
              >
                <div className="flex items-start">
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${area.color} rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}
                  >
      ...
      <section className="py-16 bg-white/20 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Simple steps to help you receive the most from our time together. Your
              guides are already preparing messages for you.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="text-left max-w-2xl mx-auto space-y-4 text-gray-700 leading-relaxed">
              <p>
                <strong>Your session begins</strong> with a brief connection as Jae
                attunes to your energy and opens to receive messages from your spiritual
                guides.
              </p>
              <p>
                <strong>Spirit messages flow naturally</strong> as your guides share
                wisdom, comfort, and guidance specifically for you. These messages often
                address things you&apos;ve been thinking about, even if you haven&apos;t
                asked aloud.
              </p>
              <p>
                <strong>Past life insights</strong> may emerge to explain current
                patterns, relationships, or challenges you&apos;re experiencing. These
                glimpses help you understand your soul&apos;s journey and purpose.
              </p>
              <p>
              ...
              <p>
                ...
                to apply these insights in your daily life, plus a recording of your
                session for future reflection.
              </p>
            </div>
            ...
            {[
              {
                ...
                description:
                  'Your spiritual journey is sacred. Every session is completely private and confidential.',
                icon: '🤫',
              },
              {
                title: 'Safe Sacred Space',
                description:
                  'Jae holds loving, non-judgmental space for whatever wants to come through for your highest good.',
                icon: '🛡️',
              },
              {
                title: 'Divine Timing',
                description:
                  'Trust that the messages you receive are exactly what your soul needs to hear right now.',
                icon: '⏰',
              },
            ].map((item, index) => (
              <motion.div
